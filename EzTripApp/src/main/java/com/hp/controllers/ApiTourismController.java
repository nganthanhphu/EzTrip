...
public class ApiTourismController {
    ...
    @GetMapping("/tourisms/compare")
    public ResponseEntity<Map<String, String>> compareTourismServices(
        ...
        String result = this.tourismService.compareTourismServices(svcId1, svcId2, svcId3);
