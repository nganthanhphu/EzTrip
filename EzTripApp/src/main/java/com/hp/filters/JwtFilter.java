        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            try {
                ...
                if (claimsSet != null) {
                    ...
                    Boolean isActive = Boolean.parseBoolean(claimsSet.getClaimAsString("isActive"));
                    String providerType = claimsSet.getClaimAsString("providerType");
                    String role = claimsSet.getClaimAsString("role");
                    Set<GrantedAuthority> authorities = new HashSet<>();
                    authorities.add(new SimpleGrantedAuthority("ROLE_" + role));
                    UserDetails userDetails = new MyUserDetails(id, customerId, providerId, providerType, isActive, username, "", authorities);
                    if (userDetails != null) {
