...
function getProfileStrategy(role, dependencies) {
	const { form, handleChange, saving, lookupTables } = dependencies;
...
function ModalProfile({ show, onHide }) {
	...
	const profileStrategy = getProfileStrategy(currentUser?.role, { form, handleChange, saving, lookupTables });
	...
	const handleSubmit = async (event) => {
		...
		try {
			...
			profileStrategy.buildPayload(payload);
